 ...
 *
 * PHONE TWIN of apps/web/src/lib/integrity-audit.ts. Kept by hand and
 * deliberately identical below the import line: the two clients read the same
 * routes, and a shape that drifted on one platform would be a screen that
 * quietly stopped showing a finding.
 *
