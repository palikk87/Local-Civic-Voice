...
//
// This file stays so the existing `@/lib/trust-verification` imports keep working. It can be
// deleted once those import sites point at '@civic/core/trust-verification' directly.
