...
//
// This file stays so the existing `@/lib/federal-government` imports keep working. It can be
// deleted once those import sites point at '@civic/core/federal-government' directly.
