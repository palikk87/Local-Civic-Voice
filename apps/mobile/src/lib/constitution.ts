...
//
// This file stays so the existing `@/lib/constitution` imports keep working. It can be
// deleted once those import sites point at '@civic/core/constitution' directly.
