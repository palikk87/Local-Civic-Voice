 ...
 *
 * PHONE TWIN of apps/web/src/lib/article-v.ts. Kept by hand and deliberately
 * identical below the import line: the two clients read the same routes, and a
 * shape that drifted on one platform would be a screen that silently stopped
 * showing a proceeding.
 *
