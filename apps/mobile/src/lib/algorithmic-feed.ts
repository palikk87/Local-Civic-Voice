 ...
 *
 * Mobile twin: webapp/src/lib/mobile/algorithmic-feed.ts
 */
import { useQuery } from "@tanstack/react-query";
import { api } from "@/lib/api/api";
import type { Bill, FeedItem, User } from "@/lib/types";
...
/** Minimal Bill card for the attached reference; detail pages resolve the id. */
