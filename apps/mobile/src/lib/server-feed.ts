 ...
 * representation-gap polls) are left undefined and the card renders without
 * them rather than showing invented numbers.
 */
...
export async function fetchServerFeed(
  ...
  // every card on every surface (feed, discover, detail screens) shows it.
