...
//
// This file stays so the existing `@/lib/mobile/feed-algorithm` imports keep working. It
// can be deleted once those import sites point at '@civic/core/feed-algorithm' directly.
