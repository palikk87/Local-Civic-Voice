...
//
// This file stays so the existing `@/lib/mobile/bill-of-rights` imports keep working. It
// can be deleted once those import sites point at '@civic/core/bill-of-rights' directly.
